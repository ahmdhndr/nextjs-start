...
export default function NotFound() {
  return (
    <div className="flex h-full w-full items-center justify-center">
      <div className="prose space-y-4 text-center text-slate-900 dark:prose-invert dark:text-slate-300">
        ...
        <p className="w-full max-w-80 text-balance text-sm tracking-normal md:text-base">
          The page you are looking for is not found, maybe you entered the wrong
          page or the page you are looking for has changed.
        </p>
        <Link href={"/"}>
